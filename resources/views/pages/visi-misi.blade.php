    ...
    <div class="container">
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 1.5rem;">
        <div style="border: 1px solid rgba(255,255,255,0.1); border-radius: var(--radius); padding: 2rem;">
          <div style="font-size: 1.5rem; margin-bottom: 1rem; color: var(--gold);"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" style="width:1em;height:1em;"><rect x="10" y="2" width="4" height="22"/><rect x="2" y="7" width="20" height="4"/></svg></div>
